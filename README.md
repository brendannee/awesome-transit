...
- [GTFS Text-to-Speech Tester](https://github.com/BlinkTagInc/node-gtfs-tts) - A command-line tool that reads out loud all GTFS stop names using Text-to-Speech and allows flagging which stop names need Text-to-Speech values for tts_stop_name in stops.txt. 
